...
#[enum_dispatch(SwapState)]  // TODO Im not really sure what this does, this was part of the OG code and I get an error for some reason if I dont comment it out
...
impl Pack for SwapV1 {
    ...
    fn pack_into_slice(&self, output: &mut [u8]) {
        let output = array_mut_ref![output, 0, 130];
        let (
            is_initialized,
            nonce,
            token_program_id,
            ...
            pool_mint,
            token_a_mint,
        ) = mut_array_refs![output, 1, 1, 32, 32, 32, 32];
    ...
    fn unpack_from_slice(input: &[u8]) -> Result<Self, ProgramError> {
        let input = array_ref![input, 0, 130];
        ...
        let (
            ...
            pool_mint,
            token_a_mint,
        ) = array_refs![input, 1, 1, 32, 32, 32, 32];
        Ok(Self {
